...
/*  Note: This Sketch does not use the HDC20XX Library, rather it shows how to communicate directly with the HDC2010.
	...
	This sketch operates HDC2080 and HDC2010 devices over 100kHz I2C bus, each being read from sequentially in automatic mode
...
//  delayMicroseconds(550);
  ...
  */
  ...
  Wire.endTransmission();                                                 // stop transmitting
  //  delayMicroseconds(800);                                                // delay set for 14 bit conversion time for temp and humidity together - typical should be ~1270uSec
...
void loop()
{
  ...
  //      delay(1041);                              // Control of read loop timing of the sensors - this is overall loop delay, comment out or modify to go faster or slower
  //  delay(10);
}
